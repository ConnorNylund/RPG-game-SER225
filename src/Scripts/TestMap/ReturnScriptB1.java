...
public class ReturnScriptB1 extends Script {
     // Create an instance of ScreenCoordinator
    private ScreenCoordinator screenCoordinator;
    

    public ReturnScriptB1(ScreenCoordinator screenCoordinator) {
    ...
    public ArrayList<ScriptAction> loadScriptActions() {
        ...
        scriptActions.add(new ScriptAction() {
            ...
            public ScriptState execute() {
                ...
                ((TestMap)(((PlayLevelScreen)(screenCoordinator.currentScreen)).map)).destroyWall1();
